			...
			{!isOtpSent && (
				<>
					...
					<div className="space-y-4">
						<Button
							type="button"
							className="relative flex w-full cursor-not-allowed items-center justify-center space-x-2 border border-gray-300 bg-background text-foreground opacity-50 hover:bg-accent dark:border-gray-600"
